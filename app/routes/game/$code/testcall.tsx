...
export const loader: LoaderFunction = async ({ request, params }) => {
  ...
  const getAllData = async () => {
    ...
    const movie1 = await callApi("451048");
    ...
    return { movie1, movie1Details, movie1Cast };
  };
...
export default function TestCall() {
  ...
  // const poster = IMG_URL + allData.movie1.results[0].poster_path;
  // const date = allData.movie1.results[0].release_date;
    ...
    <>
      ...
      {/* <header className="modal-header">
        ...
        <ul style={{ paddingLeft: 12 }}>
          <li>
            <h2>{allData.movie1.results[0].title}</h2>
          </li>
          <li>
            <p>{year[0]}</p>
          </li>
      ...
      <div className="modal-grid-container">
        ...
        <div className="grid-item">
          <h5>SYNOPSIS</h5>
          <p>{allData.movie1.results[0].overview}</p>
        </div>
        <div className="grid-item">
          <h5>TRAILER</h5>
